...
1. Запуск docker-контейнеров:
   ...
   make up
   ```
1. 1. Примечание по поводу запуска: у меня установлен __docker-compose__ (в старом формате). Возможно, на вашей машине уже установлен __docker compose__. В этом случае вместо `docker compose up -d` нужно будет запустить `docker compose up -d`
